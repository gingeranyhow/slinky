...
# Mac
electron-packager app SoyInky --platform=darwin --arch=x64 --icon=resources/Icon.icns --extend-info=resources/info.plist --app-bundle-id=com.inkle.inky --prune --asar.unpackDir="main-process/ink" --ignore="inklecate_win.exe"
...
appdmg resources/appdmg.json ReleaseUpload/SoyInky_mac.dmg

# zip -r ReleaseUpload/SoyInky-mac.zip SoyInky-darwin-x64/
